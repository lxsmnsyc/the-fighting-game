...
export default function EnergyIcon(props: EnergyIconProps): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <Tooltip anchor={icon} open={hovered()} placement={props.opens === 'up' ? 'top' : 'bottom'}>
        <div class="w-60 rounded-lg bg-zinc-900/95 p-3 text-sm shadow-xl ring-1 ring-zinc-700">
