...
const BOSSES: BossData[] = [
  ...
  { name: '1', aspect: [Aspect.Armor, Aspect.Evasion] },
  ...
  { name: '1', aspect: [Aspect.Attack, Aspect.Evasion] },
  ...
  { name: '1', aspect: [Aspect.Corrosion, Aspect.Evasion] },
  ...
  { name: '1', aspect: [Aspect.Critical, Aspect.Evasion] },
  ...
  { name: '1', aspect: [Aspect.Evasion, Aspect.Healing] },
  { name: '1', aspect: [Aspect.Evasion, Aspect.Health] },
  { name: '1', aspect: [Aspect.Evasion, Aspect.Magic] },
  { name: '1', aspect: [Aspect.Evasion, Aspect.Poison] },
  { name: '1', aspect: [Aspect.Evasion, Aspect.Slow] },
  { name: '1', aspect: [Aspect.Evasion, Aspect.Speed] },
